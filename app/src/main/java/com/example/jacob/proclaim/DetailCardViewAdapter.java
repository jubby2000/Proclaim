...
public class DetailCardViewAdapter extends RecyclerView.Adapter<CardViewHolder> {
    ...
    public void onBindViewHolder(final CardViewHolder holder, final int position) {
        ...
        if (quotes.get(position).favorite) {
            ...
            holder.mFavorite.getDrawable().mutate().setColorFilter(context.getColor(R.color.lightGray), PorterDuff.Mode.SRC_ATOP);
        }
        ...
        holder.mFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!quotes.get(position).favorite) {
                    ...
                    holder.mFavorite.setImageResource(R.drawable.ic_favorite_border_black_24dp);
                    holder.mFavorite.getDrawable().mutate().setColorFilter(v.getContext().getColor(R.color.lightGray), PorterDuff.Mode.SRC_ATOP);
